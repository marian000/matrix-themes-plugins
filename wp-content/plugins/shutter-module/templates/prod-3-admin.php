<?php
    ...
    echo $property_style = get_post_meta($product_id, 'property_style', true);
    ...
    $bp11 = get_post_meta($product_id, 'property_bp11', true);
    $bp12 = get_post_meta($product_id, 'property_bp12', true);
    $bp13 = get_post_meta($product_id, 'property_bp13', true);
...
<div class="main-content">
    <div class="page-content" style="background-color: #F7F7F7">
        <div class="page-content-area">
            ...
            <div class="row">
                <form edit="yes" accept-charset="UTF-8" action="/order_products/add_single_product" data-type="json" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                            ...
                                            <div class="panel-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3" id="room-other" style="display: block">
                                                        Room Name:
                                                        <br/>
                                                        <input class="input-medium required" id="property_room_other" name="property_room_other" style="height: 30px" type="text" value="<?php echo get_post_meta($product_id, 'property_room_other', true); ?>"
                                                        />
                                                    </div>
                                                    <div class="col-sm-3">
                                                        Material:
                                                        <br/>
                                                        <input class="property-select" id="property_material" name="property_material" type="text" value="<?php echo get_post_meta($product_id, 'property_material', true); ?>"
                                                        />
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div id="choose-style">
                                                            <label>
                                                                <br/> Full Height
                                                                <br/>
                                                                <input type="radio" name="property_style" data-code="fullheight" data-title="Full Height" value="29" <?php if ($property_style == '29') {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label style="display:none;">
                                                                <br/> Tier-on-Tier
                                                                <br/>
                                                                <input type="radio" name="property_style" data-code="tot" data-title="Tier-on-Tier" value="31" <?php if ($property_style == '31') {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label style="display:none;">
                                                                <br/> Café Style
                                                                <br/>
                                                                <input type="radio" name="property_style" data-code="cafe" data-title="Café Style" value="30" <?php if ($property_style == '30') {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label style="display:none;">
                                                                <br/> Bay Window
                                                                <br/>
                                                                <input type="radio" name="property_style" data-code="bay" data-title="Bay Window" value="32" <?php if ($property_style == '32') {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label style="display:none;">
                                                                ...
                                                                <br/>
                                                                <input type="radio" name="property_style" data-code="bay-tot" data-title="Bay Window Tier-on-Tier" value="146" <?php if ($property_style == '146') {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label style="display:none;">
                                                                ...
                                                                <br/>
                                                                <input type="radio" name="property_style" data-code="cafe-bay" data-title="Café Style Bay Window" value="225" <?php if ($property_style == '225') {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label>
                                                                <br/> Solid Flat Panel
                                                                <br/>
                                                                <input type="radio" name="property_style" data-code="solid-flat" data-title="Solid Flat Panel" value="221" <?php if ($property_style == '221') {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label style="display:none;">
                                                                ...
                                                                <br/>
                                                                <input type="radio" name="property_style" data-code="solid-flat-tot" data-title="Solid Flat Tier-on-Tier" value="227" <?php if ($property_style == '227') {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label style="display:none;">
                                                                ...
                                                                <br/>
                                                                <input type="radio" name="property_style" data-code="solid-raised" data-title="Solid Raised Panel" value="222" <?php if ($property_style == '222') {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label style="display:none;">
                                                                ...
                                                                <br/>
                                                                <input type="radio" name="property_style" data-code="solid-raised-tot" data-title="Solid Raised Tier-on-Tier" value="228" <?php if ($property_style == '228') {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label>
                                                                ...
                                                                <br/>
                                                                <input type="radio" name="property_style" data-code="solid-combi" data-title="Combi Panel" value="229" <?php if ($property_style == '229') {
                                                                    echo "checked";
                                                                } ?> />
                                                                <img src="/wp-content/plugins/shutter-module/imgs/combi-panel.jpg">
                                                            </label>
                                                            <label style="display:none;">
                                                                Solid Raised<br/>Café Style
                                                                <br/>
                                                                <input type="radio" name="property_style" data-code="solid-raised-cafe-style" data-title="Solid Raised Café Style" value="226" <?php if ($property_style == '226') {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label style="display:none;">
                                                                <br/> Special Shaped
                                                                <br/>
                                                                <input type="radio" name="property_style" data-code="shaped" data-title="Special Shaped" value="33" <?php if ($property_style == '33') {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label style="display:none;">
                                                                <br/> French Door Cut
                                                                <br/>
                                                                <input type="radio" name="property_style" data-code="french" data-title="French Door Cut" value="34" <?php if ($property_style == '34') {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label style="display:none;">
                                                                <br/> Tracked
                                                                <br/>
                                                                <input type="radio" name="property_style" data-code="tracked" data-title="Tracked" value="35" <?php if ($property_style == '35') {
                                                                    echo "checked";
                                                                } ?> />
                                                                <img src="/wp-content/plugins/shutter-module/imgs/Tracked-Shutters.png">
                                                            </label>
                                                        </div>
                                                    </div>
                                ...
                                <span id="provided-shape">
                                                            ...
                                                            <input type="text" id="attachment" name="attachment" style="visibility: hidden;" value="<?php if ($attachment) {
                                                                echo $attachment;
                                                            } ?>"/>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row" style="margin-top:1em;">
                                                    <div class="col-sm-2">
                                                        Width (mm):
                                                        <br/>
                                                        <input class="required number input-medium" id="property_width" name="property_width" type="text" value="<?php echo get_post_meta($product_id, 'property_width', true); ?>"/>
                                                    </div>
                                                    <div class="col-sm-2">
                                                        Height (mm):
                                                        <br/>
                                                        <input class="required number input-medium" id="property_height" name="property_height" type="text" value="<?php echo get_post_meta($product_id, 'property_height', true); ?>"/>
                                                    </div>
                                                    
                                                    <div class="col-sm-2" id="solid-panel-height" style="display:none;">
                                                        Solid Panel Height (mm):
                                                        <br/>
                                                        <input class=" number input-medium" id="property_solidpanelheight" name="property_solidpanelheight" type="text" value="<?php echo get_post_meta($product_id, 'property_solidpanelheight', true); ?>"/>
                                                    </div>
                                                    
                                                    <div class="col-sm-2" id="midrail-height">
                                                        Midrail Height (mm):
                                                        <br/>
                                                        <input class="required number input-medium" id="property_midrailheight" name="property_midrailheight" type="text" value="<?php echo get_post_meta($product_id, 'property_midrailheight', true); ?>"
                                                        />
                                                    </div>
                                                    <div class="col-sm-2" id="midrail-height2">
                                                        Midrail Height 2 (mm):
                                                        <br/>
                                                        <input class=" number input-medium" id="property_midrailheight2" name="property_midrailheight2" type="text" value="<?php echo get_post_meta($product_id, 'property_midrailheight2', true); ?>"
                                                        />
                                                    </div>
                                                    <div class="col-sm-2" id="midrail-divider">
                                                        Hidden Divider 1 (mm):
                                                        <br/>
                                                        <input class=" number input-medium" id="property_midraildivider1" name="property_midraildivider1" type="text" value="<?php echo get_post_meta($product_id, 'property_midraildivider1', true); ?>"
                                                        />
                                                    </div>
                                                    <div class="col-sm-2" id="midrail-divider2">
                                                        Hidden Divider 2 (mm):
                                                        <br/>
                                                        <input class=" number input-medium" id="property_midraildivider2" name="property_midraildivider2" type="text" value="<?php echo get_post_meta($product_id, 'property_midraildivider2', true); ?>"
                                                        />
                                                    </div>
                                  ...
                                  <span class="input-group-addon" title="Please note, if mid rail is selected as critical, top and bottom rails will be different sizes. If not, they will be manufactured evenly but the mid rail location may change by +/- 25.4mm"
                                        data-toggle="tooltip" data-placement="top">?</span>
                                                                <input class="property-select" id="property_midrailpositioncritical" name="property_midrailpositioncritical" type="text"
                                                    ...
                                                    <div class="col-sm-2 tot-height" style="display: none">
                                                        T-o-T Height (mm):
                                                        <br/>
                                                        <input class="required number input-medium" id="property_totheight" name="property_totheight" type="text" value="<?php echo get_post_meta($product_id, 'property_totheight', true); ?>"
                                                        />
                                                    </div>
                                                    <div class="col-sm-2 tot-height horizontal-t-post" style="display: none" ata-toggle="tooltip" title="The horizontal T Post will be apllied at T-o-T height">
                                                        Horizontal T Post
                                                        <br/>
                                                        <input id="property_horizontaltpost" name="property_horizontaltpost" type="checkbox" value="Yes" <?php if ($property_horizontaltpost == 'Yes') {
                                                            echo "checked";
                                                        } ?>/>
                                                        />
                                                    </div>
                                                    <div class="col-sm-2">
                                                        Louvre Size:
                                                        <br/>
                                                        <input class="property-select required bladesize_porperty" id="property_bladesize" name="property_bladesize" type="text" value="<?php echo get_post_meta($product_id, 'property_bladesize', true); ?>"
                                                        />
                                                    </div>
                                                </div>
                                  ...
                                  <span class="input-group-addon" title="IMPORTANT! Default should be Outside. If you are unsure please check specification sheet under Downloads. "
                                        data-toggle="tooltip" data-placement="top">?</span>
                                                                <input class="property-select" id="property_fit" name="property_fit" type="text" value="<?php echo get_post_meta($product_id, 'property_fit', true); ?>"
                                                                />
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div id="choose-frametype">
                                                            <label>
                                                                <br/> P4028X
                                                                <input type="radio" name="property_frametype" data-code="BL90" data-title="BL90" value="171" <?php if ($property_frametype == '171'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                ...
                                                <div class="row frames" style="margin-top:1em; margin-bottom: 20px;">
                                                    <div class="col-sm-12">
                                                        <div class="pull-left" id="frame-left">
                                                            ...
                                                            <br/>
                                                            <input class="property-select" id="property_frameleft" name="property_frameleft" type="text" value="<?php echo get_post_meta($product_id, 'property_frameleft', true); ?>"
                                                            />
                                                        </div>
                                                        <div class="pull-left" id="frame-right">
                                                            ...
                                                            <br/>
                                                            <input class="property-select" id="property_frameright" name="property_frameright" type="text" value="<?php echo get_post_meta($product_id, 'property_frameright', true); ?>"
                                                            />
                                                        </div>
                                                        <div class="pull-left" id="frame-top">
                                                            ...
                                                            <br/>
                                                            <input class="property-select" id="property_frametop" name="property_frametop" type="text" value="<?php echo get_post_meta($product_id, 'property_frametop', true); ?>"
                                                            />
                                                        </div>
                                                        <div class="pull-left" id="frame-bottom">
                                                            ...
                                                            <br/>
                                                            <input class="property-select" id="property_framebottom" name="property_framebottom" type="text" value="<?php echo get_post_meta($product_id, 'property_framebottom', true); ?>"
                                                            />
                                                        </div>
                                ...
                                <span id="add-buildout">
                                  ...
                                  <input class="input-small" id="property_builtout" name="property_builtout" placeholder="Enter buildout" style="height: 30px;"
                                         type="text" value="<?php echo get_post_meta($product_id, 'property_builtout', true); ?>"
                                  />
                                  <button class="btn btn-danger btn-input" id="remove-buildout">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12" id="stile-img-earth">
                                                        <div id="choose-frametype" class="col-sm-12 " style="display: block;">
                                                            ...
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_stile" data-code="FS 50.8" data-title="51mm A1002B (Std.beaded stile)" value="350" <?php if ($property_stile == '350'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                        ...
                                                        <div id="choose-frametype" class="col-sm-12 " style="display: block;">
                                                            ...
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_stile" data-code="FS 50.8" data-title="51mm PVC-P1001B(plain butt)"
                                                                       value="380" <?php if ($property_stile == '380') {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_stile" data-code="DFS 50.8" data-title="51mm PVC-P1005B(plain D-mould)"
                                                                       value="381" <?php if ($property_stile == '381') {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_stile" data-code="RFS 50.8" data-title="51mm PVC-P1003E(plain rebate)"
                                                                       value="385" <?php if ($property_stile == '385') {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_stile" data-code="BS 50.8" data-title="51mm PVC-P1002B(beaded butt)"
                                                                       value="382" <?php if ($property_stile == '382') {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_stile" data-code="DBS 50.8" data-title="51mm PVC-P1006B(beaded D-mould)"
                                                                       value="383" <?php if ($property_stile == '383') {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_stile" data-code="RBS 50.8" data-title="51mm PVC-P1004E(beaded rebate)"
                                                                       value="384" <?php if ($property_stile == '384') {
                                                                    echo "checked";
                                                                } ?> />
                                                    ...
                                                    <div class="col-sm-12" id="stile-img-basswood">
                                                        <div id="choose-frametype" class="col-sm-12 " style="display: block;">
                                                            ...
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_stile" data-code="FS 50.8" data-title="51mm 1001B( plain butt)" value="355" <?php if ($property_stile == '355'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_stile" data-code="DFS 50.8" data-title="51mm 1005B(plain D-mould)" value="356" <?php if ($property_stile == '356'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_stile" data-code="RFS 50.8" data-title="51mm 1003B(plain rebate)" value="360" <?php if ($property_stile == '360'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_stile" data-code="BS 50.8" data-title="51mm 1002B(beaded butt)" value="357" <?php if ($property_stile == '357'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_stile" data-code="DBS 50.8" data-title="51mm 1006B(beaded D-mould)" value="358" <?php if ($property_stile == '358'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_stile" data-code="RBS 50.8" data-title="51mm 1004B(beaded rebate)" value="359" <?php if ($property_stile == '359'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_stile" data-code="FS 38.1" data-title="35mm 1001A(plain butt)" value="361" <?php if ($property_stile == '361'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_stile" data-code="DFS 38.1" data-title="35mm 1005A(plain D-mould)" value="362" <?php if ($property_stile == '362'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_stile" data-code="RFS 38.1" data-title="35mm 1003A(plain rebate)" value="366" <?php if ($property_stile == '366'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_stile" data-code="BS 38.1" data-title="35mm 1002A(beaded butt)" value="363" <?php if ($property_stile == '363'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_stile" data-code="DBS 38.1" data-title="35mm 1006A(beaded D-mould)" value="364" <?php if ($property_stile == '364'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_stile" data-code="RBS 38.1" data-title="35mm 1004A(beaded rebate)" value="365" <?php if ($property_stile == '365'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                        ...
                                                        <div id="choose-frametype" class="col-sm-12 " style="display: block;">
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_stile" data-code="FS 50.8" data-title="41mm T1001M(plain butt)"
                                                                       value="376" <?php if ($property_stile == '376') {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_stile" data-code="DFS 50.8" data-title="41mm T1005M(plain D-mould)"
                                                                       value="377" <?php if ($property_stile == '377') {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_stile" data-code="RFS 50.8" data-title="41mm T1003M(plain rebate)"
                                                                       value="378" <?php if ($property_stile == '378') {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_stile" data-code="FS 50.8" data-title="51mm T1001K(plain butt)" value="370" <?php if ($property_stile == '370'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_stile" data-code="DFS 50.8" data-title="51mm T1005K(plain D-mould)" value="371" <?php if ($property_stile == '371'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_stile" data-code="RFS 50.8" data-title="51mm T1003K(plain rebate)" value="375" <?php if ($property_stile == '375'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_stile" data-code="BS 50.81" data-title="51mm T1002K(beaded butt)" value="372" <?php if ($property_stile == '372'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_stile" data-code="DBS 50.8" data-title="51mm T1006K(beaded D-mould)" value="373" <?php if ($property_stile == '373'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_stile" data-code="RBS 50.8" data-title="51mm T1004K(beaded rebate)" value="374" <?php if ($property_stile == '374'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                    ...
                                                    <div class="col-sm-12" id="stile-img-green">
                                                        <div id="choose-frametype" class="col-sm-12 " style="display: block;">
                                                            ...
                                                            <label>
                                                                <br/> 51mm PVC-P1001B(plain butt)
                                                                <input type="radio" name="property_stile" data-code="FS 50.8" data-title="51mm PVC-P1001B(plain butt)" value="380" <?php if ($property_stile == '380'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                                <img class="stile-1" src="/wp-content/plugins/shutter-module/imgs/P1001B.png"/>
                                                            ...
                                                            <label>
                                                                <br/> 51mm PVC-P1005B(plain D-mould)
                                                                <input type="radio" name="property_stile" data-code="DFS 50.8" data-title="51mm PVC-P1005B(plain D-mould)" value="381" <?php if ($property_stile == '381'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                                <img class="stile-2" src="/wp-content/plugins/shutter-module/imgs/P1005B.png"/>
                                                            ...
                                                            <label>
                                                                <br/> 51mm PVC-P1003E(plain rebate)
                                                                <input type="radio" name="property_stile" data-code="RFS 50.8" data-title="51mm PVC-P1003E(plain rebate)" value="385" <?php if ($property_stile == '385'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                                <img class="stile-3" src="/wp-content/plugins/shutter-module/imgs/P1003B.png"/>
                                                            ...
                                                            <label>
                                                                <br/> 51mm PVC-P1002B(beaded butt)
                                                                <input type="radio" name="property_stile" data-code="BS 50.8" data-title="51mm PVC-P1002B(beaded butt)" value="382" <?php if ($property_stile == '382'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                                <img class="stile-4" src="/wp-content/plugins/shutter-module/imgs/P1002B.png"/>
                                                            ...
                                                            <label>
                                                                <br/> 51mm PVC-P1006B(beaded D-mould)
                                                                <input type="radio" name="property_stile" data-code="DBS 50.8" data-title="51mm PVC-P1006B(beaded D-mould)" value="383" <?php if ($property_stile == '383'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                                <img class="stile-5" src="/wp-content/plugins/shutter-module/imgs/P1006B.png"/>
                                                            ...
                                                            <label>
                                                                <br/> 51mm PVC-P1004E(beaded rebate)
                                                                <input type="radio" name="property_stile" data-code="RBS 50.8" data-title="51mm PVC-P1004E(beaded rebate)" value="384" <?php if ($property_stile == '384'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                                <img class="stile-6" src="/wp-content/plugins/shutter-module/imgs/P1004B.png"/>
                                    ...
                                    <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        Hinge Colour:
                                                        <br/>
                                                        <input class="property-select" id="property_hingecolour" name="property_hingecolour" type="text" value="<?php echo get_post_meta($product_id, 'property_hingecolour', true); ?>"
                                                        />
                                                    </div>
                                                    <div class="col-sm-3">
                                                        Shutter Colour:
                                                        <br/>
                                                        <input class="property-select" id="property_shuttercolour" name="property_shuttercolour" type="text" value="<?php echo get_post_meta($product_id, 'property_shuttercolour', true); ?>"
                                                        />
                                                    </div>
                                                    <div class="col-sm-3" id="colour-other" style="display: none">
                                                        Other Colour:
                                                        <br/>
                                                        <input id="property_shuttercolour_other" name="property_shuttercolour_other" style="height: 30px" type="text" value="<?php echo get_post_meta($product_id, 'property_shuttercolour_other', true); ?>"
                                                        />
                                                    </div>
                                                    <div class="col-sm-3">
                                                        Blackout Blind Colour:
                                                        <br/>
                                                        <input class="property-select" id="property_blackoutblindcolour" name="property_blackoutblindcolour" type="text" value="<?php echo get_post_meta($product_id, 'property_blackoutblindcolour', true); ?>"/>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        Control Type:
                                                        <br/>
                                                        <input class="property-select" id="property_controltype" name="property_controltype" type="text" value="<?php echo get_post_meta($product_id, 'property_controltype', true); ?>"
                                                        />
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-sm-6" id="layoutcode-column">
                                                        ...
                                                        <div class="input-group-container">
                                                            <div class="input-group">
                                                                ...
                                                                <input class="required input-medium" id="property_layoutcode" name="property_layoutcode" style="text-transform:uppercase"
                                                                       type="text" value="<?php echo strtoupper(get_post_meta($product_id, 'property_layoutcode', true)); ?>"
                                                                />
                                                            </div>
                                                            <div class="note-ecowood-angle" style="<?php if($material != 188 ){ echo 'display: none'; } ?>;">Note: this material allows only 90 and 135 bay angles</div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <span class="extra-column-label">Bay Post
                                            <?php echo $i; ?>
                                                                            ...
                                                                            <div class="input-group">
                                                                                ...
                                                                                <input name="property_bp<?php echo $i; ?>" id="property_bp<?php echo $i; ?>" class="input-small required" type="text" value="<?php echo get_post_meta($product_id, 'property_bp' . $i, true); ?>">
                                                                            </div>
                                                                        </div>
                                        ...
                                        <span class="extra-column-label">Bay Angle
                                            <?php echo $i; ?>
                                                                            ...
                                                                            <div class="input-group">
                                                                                ...
                                                                                <?
                                                                                    if ($material == '188') { ?>
                                                                                        <select class="b-angle-select" id="property_ba<?php echo $i; ?>">
                                                                                    ...
                                                                                    <?php } else {
                                                                                        ?>
                                                                                        <input name="property_ba<?php echo $i; ?>" id="property_ba<?php echo $i; ?>" class="input-small required" type="text" value="<?php echo get_post_meta($product_id, 'property_ba' . $i, true); ?>">
                                                                                    <?php } ?>
                                                                            </div>
                                                                        </div>
                                          ...
                                          <span class="extra-column-label">B-Post Buildout
                                              <?php echo $i; ?>
                                                                                ...
                                                                                <div class="input-group">
                                                                                    <span data-placement="top" data-toggle="tooltip" title="" class="input-group-addon" data-original-title="Type in the layout code">?</span>
                                                                                    <input name="property_b_buildout<?php echo $i; ?>" id="property_b_buildout<?php echo $i; ?>" class="input-small" type="checkbox" value="yes" <?php if (get_post_meta($product_id, 'property_b_buildout' . $i, true) == 'yes') {
                                                                                        echo 'checked';
                                                                                    } ?>>
                                                                                </div>
                                                                            </div>
                                          ...
                                          <span class="extra-column-label">T-Post
                                              <?php echo $i; ?>
                                                                            ...
                                                                            <div class="input-group">
                                                                                <span data-placement="top" data-toggle="tooltip" title="" class="input-group-addon" data-original-title="Type in the layout code">?</span>
                                                                                <input name="property_t<?php echo $i; ?>" id="property_t<?php echo $i; ?>" class="input-small required" type="text" value="<?php echo get_post_meta($product_id, 'property_t' . $i, true); ?>">
                                                                            </div>
                                                                        </div>
                                                                        
                                                                        <!-- disabled by teo --><?php if (false) { ?>
                                            ...
                                            <span class="extra-column-label">T-Post Buildout
                                                <?php echo $i; ?>
                                                                                    ...
                                                                                    <div class="input-group">
                                                                                        <span data-placement="top" data-toggle="tooltip" title="" class="input-group-addon" data-original-title="Type in the layout code">?</span>
                                                                                        <input name="property_t_buildout<?php echo $i; ?>" id="property_t_buildout<?php echo $i; ?>" class="input-small" type="checkbox" value="yes" <?php if (get_post_meta($product_id, 'property_t_buildout' . $i, true) == 'yes') {
                                                                                            echo 'checked';
                                                                                        } ?>>
                                                                                    </div>
                                                                                </div>
                                      ...
                                      <span class="extra-column-label">G-Post
                                          <?php echo $i; ?>
                                                                            ...
                                                                            <div class="input-group">
                                                                                <span data-placement="top" data-toggle="tooltip" title="" class="input-group-addon" data-original-title="Type in the layout code">?</span>
                                                                                <input name="property_g<?php echo $i; ?>" id="property_g<?php echo $i; ?>" class="input-small required" type="text" value="<?php echo get_post_meta($product_id, 'property_g' . $i, true); ?>">
                                                                            </div>
                                                                        </div>
                                        ...
                                        <span class="extra-column-label">G-Post Buildout
                                            <?php echo $i; ?>
                                                                                    ...
                                                                                    <div class="input-group">
                                                                                        <span data-placement="top" data-toggle="tooltip" title="" class="input-group-addon" data-original-title="Type in the layout code">?</span>
                                                                                        <input name="property_g_buildout<?php echo $i; ?>" id="property_g_buildout<?php echo $i; ?>" class="input-small" type="checkbox" value="yes" <?php if (get_post_meta($product_id, 'property_g_buildout' . $i, true) == 'yes') {
                                                                                            echo 'checked';
                                                                                        } ?>>
                                                                                    </div>
                                                                                </div>
                                    ...
                                    <span class="extra-column-label">C-Post
                                        <?php echo $i; ?>
                                                                            ...
                                                                            <div class="input-group">
                                                                                <span data-placement="top" data-toggle="tooltip" title="" class="input-group-addon" data-original-title="Type in the layout code">?</span>
                                                                                <input name="property_c<?php echo $i; ?>" id="property_c<?php echo $i; ?>" class="input-small required" type="text" value="<?php echo get_post_meta($product_id, 'property_c' . $i, true); ?>">
                                                                            </div>
                                                                        </div>
                                          ...
                                          <span class="extra-column-label">C-Post Buildout
                                              <?php echo $i; ?>
                                                                                ...
                                                                                <div class="input-group">
                                                                                    <span data-placement="top" data-toggle="tooltip" title="" class="input-group-addon" data-original-title="Type in the layout code">?</span>
                                                                                    <input name="property_c_buildout<?php echo $i; ?>" id="property_c_buildout<?php echo $i; ?>" class="input-small" type="checkbox" value="yes" <?php if (get_post_meta($product_id, 'property_c_buildout' . $i, true) == 'yes') {
                                                                                        echo 'checked';
                                                                                    } ?>>
                                                                                </div>
                                                                            </div>
                                                            ...
                                                            foreach ($nr_code_prod as $key => $val) {
                                                                for ($i = 1; $i < $val + 1; $i++) {
                                                                    if ($key == 'b') {
                                                                        ...
                                                                        <?php if ($i == 1) { ?>
                                                                            <div class="pull-left extra-column-buildout <?php if ($material == '188') { echo 'b-angle-select-type'; } ?>">
                                                                            ...
                                                                            <div class="pull-left extra-column-buildout property_b_buildout1" <?php if ($bay_post_type == 'flexible') { ?> style="display: none;" <?php } ?> >
                                                                              <span class="extra-column-label">B-Post Buildout
                                                                                  <? //php echo $i; ?>
                                                                              </span>:
                                                                                <br>
                                          ...
                                          <span class="extra-column-label">C-Post Buildout
                                              <?php echo $i; ?>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="tpost-type" style="<?php if (get_post_meta($product_id, 'property_tposttype', true)) {
                                                        echo 'display: block';
                                                    } else {
                                                        echo 'display: none';
                                                    } ?>">
                                                        <div class="col-sm-12 tpost-img type-img-earth" style="display: none;">
                                                            ...
                                                            <label>
                                                                <br/> A7001 - Earth Std. T-Post"
                                                                <input type="radio" name="property_tposttype" data-code="RBS 50.8" data-title="A7001 - Earth Std. T-Post" value="442" <?php if ($property_tposttype == '442'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                    ...
                                                    <div class="tpost-type" style="display: none;">
                                                        <div class="col-sm-12 tpost-img type-img-ecowood" style="display: none;">
                                                            ...
                                                            <label>
                                                                ...
                                                                <input type="radio" name="property_tposttype" data-code="RBS 50.8" data-title="P7032 - Standard T-Post" value="437" <?php if ($property_tposttype == '437'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                    ...
                                                    <div class="tpost-type" style="<?php if (get_post_meta($product_id, 'property_tposttype', true)) {
                                                        ...
                                                        <div class="col-sm-12 tpost-img type-img-basswood" style="display: none;">
                                                            ...
                                                            <label>
                                                                <br/>
                                                                <p>7201 - T-Post with insert</p>
                                                                <input type="radio" name="property_tposttype" data-code="RBS 50.8" data-title="7201 - T-Post with insert" value="439" <?php if ($property_tposttype == '439'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                                            ...
                                                            <label>
                                                                <br/>
                                                                <p>7011 - Large T-Post</p>
                                                                <input type="radio" name="property_tposttype" data-code="RBS 50.8" data-title="7011 - Large T-Post" value="441" <?php if ($property_tposttype == '441'
                                                                ) {
                                                                    echo "checked";
                                                                } ?> />
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 col-md-6">
                                                        Comments:
                                                        <br/>
                                                        <textarea id="comments_customer" name="comments_customer" rows="5" style="width: 100%"><?php echo get_post_meta($product_id, 'comments_customer', true); ?></textarea>
                                                        <hr/>
                                                        ...
                                                        <div class="quantity">
                                                            Number of this
                                                            <input id="quantity" class="input-text qty text" min="1" max="" name="quantity" value="<?php echo $quant; ?>" title="Qty"
                                                        ...
                                                        <input class="" id="panels_left_right" name="panels_left_right"
                                                               type="hidden" value="<?php echo strtoupper(get_post_meta($product_id, 'panels_left_right', true)); ?>"
                                                        />
...
<script>
    ...
    jQuery('#add-product-single-form .btn.btn-primary.update-btn-admin').on('click', function (e) {
        e.preventDefault();
