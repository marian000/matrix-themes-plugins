                        ...
                        <div class="row" style="margin-top:1em;">
                            ...
                            <div class="col-sm-8" id="shape-section" style="display: block">
                                ...
                                <span id="provided-shape">
                                    ...
                                    <input type="text" id="attachment" name="attachment" style="visibility: hidden;" value="<?php echo $attachment; ?>"/>
                                </div>
                            </div>
                        </div>
...
<!--                                <br>-->
<!--                                <label>-->
<!--                                    <input type="radio" name="batten_type" value="custom" --><?php //if ($batten_type == 'custom') {
//                                        echo 'checked';
//                                    } ?><!-- >-->
<!--                                    Custom-->
<!--                                </label>-->
<!--                                <label>-->
<!--                                    <input type="radio" name="batten_type" value="standard" --><?php //if ($batten_type == 'standard') {
//                                        echo 'checked';
//                                    } ?><!-- > -->
<!--                                    Standard-->
<!--                                </label>-->
<!--                            </div>-->
                            <div class="col-sm-2">
                                Width (mm):
                                <input class="required" id="property_width" name="property_width" type="number" value="<?php echo get_post_meta($product_id, 'property_width', true); ?>"/>
                            </div>
                            <div class="col-sm-2">
                                Height (mm):
                                <input class="required" id="property_height" name="property_height" type="number" value="<?php echo get_post_meta($product_id, 'property_height', true); ?>"
                            ...
                            <div class="col-sm-2">
                                Depth (mm):
                                <input class="required" id="property_depth" name="property_depth" type="number" value="<?php echo get_post_meta($product_id, 'property_depth', true); ?>"
                                    <?php if ($batten_type == 'standard') {
                                        echo 'readonly';
                                    } ?>
                                />
                            ...
                            <div class="col-sm-2">
                                Total (cb/m):
                                <input name="property_total" type="text"  style="pointer-events: none;"
                        ...
                        <div class="row" style="margin-top:1em;">
                            ...
                            <div class="col-sm-2" id="room-other" style="display: block">
                                Room name:
                                <br/>
                                <input id="property_room_other" name="property_room_other" style="height: 30px" type="text" value="<?php echo get_post_meta($product_id, 'property_room_other', true); ?>"/>
                            </div>
                            <div class="col-sm-2">
                                Colour:
                                <br/>
                            ...
                            <div class="col-sm-2" id="colour-other" style="display: none">
                                Other Colour:
                                <br/>
                                <input id="property_shuttercolour_other" name="property_shuttercolour_other" style="height: 30px" type="text"
                                        value="<?php echo get_post_meta($product_id, 'property_shuttercolour_other', true); ?>"/>
                            </div>
                            <div class="col-sm-2">
                                Quantity:
                                <input id="quantity" class="input-text qty text" min="1" max="" name="quantity" value="<?php echo get_post_meta($product_id, 'quantity', true); ?>" title="Qty"
