...
<button class="btn btn-primary insert_orders hide hidden">Generate custom order for custom Table</button>

<button class="accordion btn btn-primary no-results ">Old Orders with no Container</button>
<div class="panel">
...
<script>
    ...
    jQuery(document).ready(function () {
        ...
        jQuery.ajax({
            method: "POST",
            url: "/wp-content/themes/storefront-child/ajax/older-orders.php",
            data: {search: "true"},
            beforeSend: function () {
