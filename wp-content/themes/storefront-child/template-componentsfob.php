 ...
 *
 * Template Name: Components-FOB-Shop
 *
 */
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="page-header">
                                <h1>Add Components FOB - minimum order - 20ft or 40 ft container</h1>
                            </div>
                                    ...
                                    <?php if ($query->have_posts()) : while ($query->have_posts()) : $query->the_post();
                                        ...
                                        <li class="col-sm-3" style="opacity: 1;">
                                            <div class="thumbnail">
                                                ...
                                                <p class="price">
                                                    $<?php echo '<span class="price">' . $product->get_price() . '</span><small>per BOX</small>'; ?>
                                                </p>
