            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab1">
                    <div class="row">
                        ...
                        <div class="col-sm-3 col-md-3">
                            <div class="field">
                                <label for="customer_customer_detail_attributes_address">Billing Address</label>
                                <br>
                                <input class="large" id="customer_customer_detail_attributes_address" name="billing_address_1"
                                    type="text" value="<?php echo $billing_address_1; ?>" disabled>
                                <input class="large" id="customer_customer_detail_attributes_address2" name="billing_address_2"
                                    type="text" value="<?php echo $billing_address_2; ?>" disabled>
                            </div>
                            <div class="field">
                                <label for="customer_customer_detail_attributes_city">Town/City</label>
                                <br>
                                <input id="customer_customer_detail_attributes_city" name="billing_city" type="text" value="<?php echo $billing_city; ?>" disabled>
                            </div>
                            <div class="field">
                                <label for="customer_customer_detail_attributes_province">County</label>
                                <br>
                                <input id="customer_customer_detail_attributes_province" name="billing_state" type="text"
                                    value="<?php echo $billing_state; ?>" disabled>
                            </div>

                            <div class="field">
                                <label for="customer_customer_detail_attributes_country">Country</label>
                                <br>
                                <input id="customer_customer_detail_attributes_country" name="billing_country" type="text"
                                    value="<?php echo $billing_country; ?>" disabled>
                            </div>
                            <div class="field">
                                <label for="customer_customer_detail_attributes_postal_code">Postcode</label>
                                <br>
                                <input id="customer_customer_detail_attributes_postal_code" name="billing_postcode" type="text"
                                    value="<?php echo $billing_postcode; ?>" disabled>
                            </div>
                        ...
                        <div class="col-sm-3 col-md-3">
                            <div class="field">
                                <label for="customer_customer_detail_attributes_address">Delivery Address</label>
                                <br>
                            ...
                            <div class="field">
                                <label for="customer_customer_detail_attributes_province">County</label>
                                <br>
                                <input id="customer_customer_detail_attributes_province" name="shipping_state" type="text"
                                    value="<?php echo $shipping_state; ?>" disabled>
                            </div>
