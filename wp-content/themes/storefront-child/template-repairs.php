...
//                        echo $order->customer_id;
      ...
      <div>
        <table class="table repair repair-1">
          <thead style="background-color: #f2dede;">
          <th></th>
          <th>
            Repair Order
...
//					$users_orders[] = $deler_id;
              ...
              <tr>
                ...
                <td>
									<?php echo get_the_date('Y-m-d', get_the_ID()); ?>
                </td>
                <td>
                ...
                <td>
									<?php
									$container_id = get_post_meta(get_the_ID(), 'container_id', true);
									// show container name
									if ($container_id != "") {
										$container_name = get_the_title($container_id);
										echo $container_name;
									}
									?>
                </td>
