...
<table class="form-table" id="fieldset-custom">
  ...
  <tr>
    ...
    <tr>
        ...
        <td>
            <input name="show_biowood" type="radio" id="show_biowood_yes" value="yes" checked
              <?php
//              if ($show_biowood === 'yes' || empty($show_biowood)) {
//				echo 'checked';
//			} 
            ?>>
