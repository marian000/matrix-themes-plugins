...
<table class="form-table" id="fieldset-custom">
        ...
        <select name="company_parent">
          <option value="0">None</option>
					...
					foreach ($dealers as $dealer) {
						?>
            <option value="<?php echo esc_attr( $dealer->ID ); ?>" <?php
      ...
      <td>
        <ul>
					...
					foreach ($employees as $user_emp_id) {
						...
						if ($user_emp) {
							echo '<li>';
							echo esc_html( $user_emp->display_name );
							?> -
              <a href="<?php echo esc_url( admin_url( 'user-edit.php?user_id=' . absint( $user_emp_id ) ) ); ?>" class=" btn
                       btn-default">Edit</a>
							<?php
							echo '</li>';
						}
  ...
  <tr>
    ...
    <tr>
        ...
        <td>
            <input name="show_biowood" type="radio" id="show_biowood_yes" value="yes"
                <?php echo ($show_biowood === 'yes') ? 'checked' : ''; ?>>
            <label for="show_biowood_yes">Yes</label>

            <input name="show_biowood" type="radio" id="show_biowood_no" value="no"
                <?php echo ($show_biowood === 'no' || empty($show_biowood)) ? 'checked' : ''; ?>>
  ...
  <tr>
    ...
    <td>
      <input name="vat_number_custom" type="text" id="vat_number" value="<?php echo esc_attr( $vat_number ); ?>">
    </td>
  </tr>
  <tr>
    <th>
    ...
    <td>
      <input name="email_contabil" type="text" id="email_contabil" value="<?php echo esc_attr( $email_contabil ); ?>">
    </td>
  </tr>
  <tr>
    <th>
    ...
    <td>
      <input name="discount_custom" type="text" id="discount_custom" value="<?php echo esc_attr( $discount_custom ); ?>">
    </td>
  </tr>
  <tr>
    <th>
      <label for="train_price">Sea price sq/m</label>
    </th>
    <td>
        <?php
        $train_price_placeholder = get_post_meta(1, 'train_price', true);
        ?>
      <input name="train_price" type="text" id="train_price" value="<?php echo esc_attr( $train_price ); ?>" placeholder="<?php echo esc_attr( $train_price_placeholder ); ?>">(default price: <?php echo esc_html( $train_price_placeholder ); ?>)
    </td>
  </tr>
  </tbody>
</table>
      ...
      <tr>
        ...
        <td>
          ...
          <input type="text" class="form-control" style="width: 100%;" placeholder="Enter price"
                 name="price-<?php echo esc_attr( $part[0] ); ?>" value="<?php echo esc_attr( $propertie_price_tax[$id] ); ?>">
        </td>
        ...
        <tr>
          ...
          <td>
            ...
            <input type="text" class="form-control" style="width: 100%;"
                   placeholder="<?php echo esc_attr( $propertie_price_placeholder[$id] ); ?>"
                   name="price-<?php echo esc_attr( $part[0] ); ?>" value="<?php echo esc_attr( $propertie_price[$id] ); ?>">
          </td>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <input type="text" class="form-control" style="width: 100%;" placeholder="Enter price"
                   name="price-dolar-<?php echo esc_attr( $part[0] ); ?>" value="<?php echo esc_attr( $propertie_price_dolar[$id] ); ?>">
          </td>
...
<?php
// Per-material pricing overrides (separate section below main pricing table)
include_once get_stylesheet_directory() . '/views/user-material-pricing.php';

// Additional pricing overrides: locks, accessories, panel width (9 keys missing from original).
include_once get_stylesheet_directory() . '/views/user-general-pricing-extra.php';
?>